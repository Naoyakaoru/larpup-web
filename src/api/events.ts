...
export function createEvent(data: { script_id: number; scheduled_at: string; location: string; host_in_game: boolean; host_cross_gender: boolean; allow_cross_gender: boolean }) {
